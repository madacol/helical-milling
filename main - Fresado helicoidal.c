...
// Configuracion inicial del PIC
	...
	TRISB = 0b00000001;		// CONFIGURA RB0, RB6 y RB7 COMO ENTRADA. Y LAS DEMAS COMO SALIDAS.
	TRISA = 0b110000;		// CONFIGURA RA4 COMO ENTRADA. Y LAS DEMAS COMO SALIDAS.
